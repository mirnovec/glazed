    ...
    private int findBlockSlot() {
        ...
        for (int i = 9; i < 36; i++) {
            ...
            if (!stack.isEmpty() && stack.getItem() instanceof BlockItem &&
                ...
                if (emptySlot != -1) {
                    mc.gameMode.handleInventoryMouseClick(0, i, 0, net.minecraft.world.inventory.ClickType.PICKUP, mc.player);
                    mc.gameMode.handleInventoryMouseClick(0, emptySlot, 0, net.minecraft.world.inventory.ClickType.PICKUP, mc.player);
                    return emptySlot;
                }
            }
        }
