...
public class SpotifyHud extends Module {
    private static final ResourceLocation ART_TEXTURE = ResourceLocation.fromNamespaceAndPath("glazed", "spotify_art");
    ...
    private void onRender2D(Render2DEvent event) {
        ...
        board.render(event.drawContext, snapshot(), hasArt && showAlbumArt.get() ? ART_TEXTURE : null,
        ...
        try {
            ...
            for (int y = 0; y < height; y++) {
                for (int x = 0; x < width; x++) {
                    ...
                    native0.setPixel(x, y, (a << 24) | (b << 16) | (g << 8) | r);
                }
            }
            ...
            artTexture = new DynamicTexture(native0);
